    ...
    <section className="section bg-light">
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <p>Modular frontend projects using React and Vite, hosted on GitHub.</p>
          <a href="https://github.com/KatBreed" target="_blank" rel="noopener noreferrer" className="btn-outline">
            Visit GitHub
          </a>
        </div>
      </div>
